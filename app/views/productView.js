        ...
        for(var i=0 ; i<this.polarCategories.length; i++){
            if(foundHotel !== undefined){
                ...
                if(criterionParentID === ""){
                    if(this.polarCategories[i] == "price"){
                    ...
                    }else if(this.polarCategories[i] == "confort"){
                        var diffConfort = Math.abs(foundHotel[this.polarCategories[i]] - App.selectedCriteria[this.polarCategories[i]].value);
                        switch(diffConfort){
