...
var SearchView = Backbone.View.extend({
    ...
    renderMap:function(dataRendering){
        ...
        if(this.searchMap === ""){
            ...
            this.searchMap.on('click', function(ev) {
                App.updateMapPosition(ev.latlng);
            });
        }
    },
    ...
    updateMapLocationFromClick:function(latlng){
        console.log("updateMapLocationFromClick", latlng);
        this.searchMap.setView([latlng.lat, latlng.lng], 11);
    },
    ...
    intialAnimateSliders:function(){
        ...
        _.each(handles, function(handle, index){
            ...
            if(criterionID == "tarifmin"){ midLeft = self.draggableMaxPx; }
            else if(criterionID == "localisation"){ midLeft = self.draggableMaxPx /1.5; }
            else if(criterionID == "categorie"){ midLeft = self.draggableMaxPx / 2; }
            else{
